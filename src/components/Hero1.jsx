...
const Hero = () => {
  return (
    <section
      id="hero"
      className="bg-dark-bg relative gap-4 text-white pt-24 flex flex-col items-center justify-center md:h-[120%] h-[70vh] text-center "
    >
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-lg md:text-xl italic fade-in mt-0">
