        ...
        {pricing.map((price, index) => (
          <div
            ...
            className={`flex ${
              ...
              index === 1
                ? "scale-[1.02] hover:scale-[1.04] h-[500px]"
                : "h-[450px]"
            }`}
          >
            ...
            <p className="text-text-medium-gray text-sm">{price.text}</p>
            ...
            <div className="flex flex-col mt-4 h-[160px] justify-between gap-4">
